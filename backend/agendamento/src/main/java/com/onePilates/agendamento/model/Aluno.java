...
//
//    public Aluno(String nome, String email, String cpf, LocalDate dataNascimento, Boolean status, Boolean alunoComLimitacoesFisicas, String tipoContato, Boolean notificacaoAtiva, Endereco endereco) {
//        this.nome = nome;
//        this.email = email;
//        this.cpf = cpf;
