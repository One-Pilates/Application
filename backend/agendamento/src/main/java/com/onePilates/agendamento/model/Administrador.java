...
public class Administrador extends Funcionario{
    ...
    public Administrador(Long id, String nome, String email, String cpf, LocalDate idade, Boolean status, String foto, String observacoes, Boolean notificacaoAtiva, String senha, String cargo, Endereco endereco) {
        super(id, nome, email, cpf, idade, status, foto, observacoes, notificacaoAtiva, senha, cargo, endereco);
    }
