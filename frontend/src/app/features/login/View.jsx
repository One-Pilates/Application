...
const LoginView = ({ email, setEmail, password, setPassword, handleLogin, navigate }) => {
  return (
    <div className="login">
      <div className="login__container" role="region" aria-label="Formulário de login">
        ...
        <form
          ...
          onSubmit={(e) => { e.preventDefault(); handleLogin(navigate); }}
        ...
        >
          ...
          <div className="login__links" id="login-help">
            <a href="#/recuperar-senha" className="login__forgot">Esqueci minha senha</a>
