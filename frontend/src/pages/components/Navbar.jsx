...
function Navbar({ navAberta, paginaAtual, setPaginaAtual, userType }) {
          ...
          {isSecretary && (
            <>
              <Sidebar
                ...
                texto="Professor"
                navAberta={navAberta}
                ativo={paginaAtual === "professor"}
                onClick={() => setPaginaAtual("professor")}
              />
              <Sidebar
                Icon={FaUsers}
                texto="Alunos"
                navAberta={navAberta}
                ativo={paginaAtual === "alunos"}
